                      ...
                      <form id="inputform" action="simpan.php" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" name="nomor" class="form-control" placeholder="Nomor Telp" required />
                          </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-center align-items-center text-center w-sm-100" style="text-align: center">
                          <button onclick="submitForm()" type="button" data-toggle="modal" data-target="#success_tic" class="btn btn-outline btn-info btn-lg ">Daftar Sekarang</button>
